const XPTN = 'UWAK BOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/yangkenoninkekkambing'; // Nama Instagramlu cok
const nomer = 'http://Wa.me/6282111538078'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @yangkenoninkekkambing`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @yangkenoninkekkambing`)
})
...
conn.sendMessage(id, 'Owner *Uwak Bot* http://Wa.me/6282111538078' ,MessageType.text, { quoted: m });
}
...
conn.sendMessage(id, 'http://Wa.me/6282111538078' ,MessageType.text, { quoted: m });
}
else if (text == '~owner'){
conn.sendMessage(id, 'http://Wa.me/6282111538078' ,MessageType.text, { quoted: m });
}
else if (text == '~groupbot'){
conn.sendMessage(id, 'Nih Bro Jangan Lupa Join https://chat.whatsapp.com/D8ViYowjnUXLt7w1VGGuzz' ,MessageType.text, { quoted: m });
}
else if (text == '~tools1'){
...
const teks = text.replace(/~ewabatch /, "")
...
const teks = text.replace(/~ccerpen /, "")
...
conn.sendMessage(id, '*🔥Nih bro fitur / command yang ada di bot ini jika ada bug / yang tidak bisa mohon maaf ya sedang dalam pertahapan, Jika anda bingun silahkan ketil *.readmi* Thanks for use UWAK BOT🔥*' ,MessageType.text, { quoted: m });
}
//else if (text == '~help'){
//conn.sendMessage(id, 'Thanks Telah Menggunakan BOT *UWAK BOT* , Follow Instagram Mimin Yah😻 : https://instagram.com/' ,MessageType.text);
//}
